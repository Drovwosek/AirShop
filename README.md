...
Хотите разместить проект в интернете для публичного доступа?

Смотрите подробную пошаговую инструкцию: **[DEPLOYMENT.md](./DEPLOYMENT.md)**

**Рекомендуется:** Vercel - платформа, оптимизированная для Next.js
- ✅ Бесплатный тариф
- ✅ Автоматический деплой при каждом push
- ✅ Глобальный CDN и HTTPS
- ✅ Деплой за 5 минут
